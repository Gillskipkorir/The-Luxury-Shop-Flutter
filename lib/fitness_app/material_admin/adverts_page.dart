...
class AdminAdvertsPage extends StatefulWidget {
  const AdminAdvertsPage({Key? key}) : super(key: key);

  @override
  _AdminAdvertsPageState createState() => _AdminAdvertsPageState();
}

class _AdminAdvertsPageState extends State<AdminAdvertsPage>
